...
export const mastra = new Mastra({
  ...
  agents: { weatherAgent, cvAnalyzerAgent, matchingAgent, recommendationAgent, applicationCoachAgent, careerStatusAgent, messageAssistantAgent, documentVerificationAgent, offerOptimizerAgent },
