...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    _cubit.openChat(widget.conversationId, isStudent: true);
  }
  ...
  void dispose() {
    ...
    _cubit.closeChat(isStudent: true);
    super.dispose();
  }
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: SafeArea(
                      bottom: false,
                      child: _buildHeaderContent(context, state),
                    ),
                  ),
                ),
  ...
  Widget _buildHeaderContent(BuildContext context, MessagingState state) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            icon: Icon(Icons.call_rounded, color: Colors.white.withOpacity(0.8)),
            onPressed: () {},
          ),
          IconButton(
            icon: Icon(Icons.videocam_rounded, color: Colors.white.withOpacity(0.8)),
            onPressed: () {},
          ),
        ],
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'messaging.error.chat_title'.tr(),
                style: AppTypography.headingSmall,
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: AppSpacing.lg),
              ElevatedButton.icon(
                onPressed: () => _cubit.openChat(
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'messaging.chat.ai_suggestions'.tr(),
                style: AppTypography.caption.copyWith(
                  color: AppColorsLight.primary,
                  fontWeight: FontWeight.w700,
                ),
          ...
          Expanded(
            child: Container(
              ...
              child: TextField(
                ...
                enabled: !isSending,
                decoration: InputDecoration(
                  hintText: 'messaging.chat.input_hint'.tr(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.md),
            Text('messaging.chat.empty_title'.tr(),
                style: AppTypography.headingSmall,
                textAlign: TextAlign.center),
            const SizedBox(height: AppSpacing.sm),
            Text(
              'messaging.chat.empty_subtitle'.tr(),
